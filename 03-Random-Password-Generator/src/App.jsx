...
function App() {
  ...
  const [Password, setPassword] = useState("adfjlksjflsj");
        ...
        <center>
          <div className="flex mt-2 shadow w-full max-w-md mx-auto rounded-lg overflow-hidden mb-4">
            <input
              ...
              readOnly
            />
            <button className="bg-orange-400 duration-100 text-[#252222] text-[0.85em] px-[10px] font-semibold hover:opacity-90 active:bg-amber-700 active:text-white cursor-pointer">
              Copy
            </button>
          </div>
        </center>
